...
<table id = "notice">
<tr><td>글쓴이</td><td><input type="text" name = "name" value="<%= gb.getName()%>" readonly></td></tr>
<tr><td>제목</td><td><input type="text" name="subject"   value="<%=gb.getSubject()%>" ></td></tr>
<tr><td>첨부파일</td><td><input type="file" name="file" >
<input type="hidden" name ="old_file"  value="<%=gb.getFile()%>" ><%=gb.getFile()%></td></tr>
<tr><td>내용</td><td><textarea name="content"  cols="20" rows="10"  ><%=gb.getContent() %></textarea></td></tr>
