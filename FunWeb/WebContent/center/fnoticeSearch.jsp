<%@page import="com.sun.org.apache.xml.internal.security.encryption.ReferenceList"%>
...
int pageSize = 2; //한 페이지에 보여줄 글 개수
...
//검색에 해당하는 모든 행의 개수-count(*)
int count = rd.getReferenceCount(search);

if(count!=0){
	//boardList = rd.getBoardList(1,10); 1페이지 글 10개
	referenceList = rd.getReferenceList(startRow,pageSize,search);
}

%>

<article>
<h1>File Notice Search [검색글개수: <%=count %>]</h1>
<table id="notice">
